...
export interface GetLegalEntityDto {
  /**
...
export interface GetLegalEntityResponseDataDto {
  /**
   * Статус объекта
...
export interface GetLegalEntityResponseLinksDto extends BaseLinksResponse {}
export interface GetLegalEntityResponseMetaDto extends BaseMetaResponse {}

export interface GetLegalEntityResponseDto {
  Data: GetLegalEntityResponseDataDto;
  Links: GetLegalEntityResponseLinksDto;
  Meta: GetLegalEntityResponseMetaDto;
}
